...
export default function EventDialog({
    ...
    // State mới để quản lý hiển thị Alert Dialog
    ...
    // 1. Khi bấm nút Delete -> Chỉ mở Alert, chưa xóa ngay
    const handleDeleteClick = () => {
        setIsDeleteAlertOpen(true);
    };

    // 2. Khi bấm Continue trong Alert -> Mới gọi hàm xóa thật
                ...
                <DialogContent className="sm:max-w-[600px] bg-white dark:bg-zinc-950 text-zinc-900 dark:text-zinc-50 border-zinc-200 dark:border-zinc-800 shadow-2xl p-0 gap-0 overflow-hidden">
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="p-6 space-y-6">
                            {/* ... (Các phần Input giữ nguyên như cũ) ... */}
                            ...
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    autoFocus={!isEditing}
                                    required
                                    className="h-auto py-1.5 text-2xl font-medium border-0 border-b border-zinc-200 dark:border-zinc-800 rounded-none px-0 bg-transparent focus-visible:ring-0 focus-visible:border-zinc-900 dark:focus-visible:border-zinc-100 placeholder:text-zinc-300 dark:placeholder:text-zinc-700 transition-colors duration-200"
                                />
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-5 rounded-xl bg-zinc-50 dark:bg-zinc-900/50 border border-zinc-100 dark:border-zinc-800">
                                <div className="space-y-3">
                                    <Label className="flex items-center gap-2 text-zinc-700 dark:text-zinc-300 font-semibold text-sm">Starts</Label>
                                ...
                                <div className="space-y-3">
                                    <Label className="flex items-center gap-2 text-zinc-700 dark:text-zinc-300 font-semibold text-sm">Ends</Label>
                                    <div className="flex flex-col gap-2">
                        ...
                        <DialogFooter className="px-6 py-4 border-t border-zinc-100 dark:border-zinc-800 bg-zinc-50/30 dark:bg-zinc-900/30 flex justify-between items-center sm:justify-between w-full">
                            {isEditing ? (
                                <Button type="button" variant="ghost" onClick={handleDeleteClick} className="text-red-600 hover:text-red-700 hover:bg-red-50 dark:hover:bg-red-950/30">
