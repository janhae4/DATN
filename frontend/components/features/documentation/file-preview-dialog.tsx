      ...
      >
        <DialogHeader className="flex flex-row items-center justify-between border-b px-4 py-3 bg-white dark:bg-zinc-950 shrink-0">
          <div className="flex items-center gap-3 overflow-hidden">
            <DialogTitle className="text-sm font-semibold truncate max-w-[300px] md:max-w-[500px]" title={file.fileName}>
              {file.fileName}
            </DialogTitle>
          ...
          <div className="flex items-center gap-1">
            <Button variant="ghost" size="icon" className="h-8 w-8 text-zinc-500" asChild>
              <a href={file.fileUrl} target="_blank" rel="noopener noreferrer" title="Mở tab mới">
            ...
            <DialogClose asChild>
              <Button variant="ghost" size="icon" className="h-8 w-8 text-zinc-500 hover:text-red-600 hover:bg-red-50">
                <X className="h-4 w-4" />
              </Button>
            </DialogClose>
          </div>
