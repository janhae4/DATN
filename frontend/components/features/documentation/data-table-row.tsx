      ...
      <ContextMenu>
        <ContextMenuTrigger asChild onContextMenu={handleContextMenu}>
          <TableRow
            ...
            className={cn(
              "group cursor-pointer hover:bg-muted/50 text-sm font-medium text-zinc-700 dark:text-zinc-300",
              isOver &&
        ...
        <ContextFileMenuContent
          ...
          menuSelectedIds={new Set([file.id])}
          projectId={projectId}
          teamId={teamId}
          currentVisibility={file.visibility || FileVisibility.TEAM}
          onPreview={onPreview}
