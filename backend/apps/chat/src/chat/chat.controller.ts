...
import { ChangeRoleMember, CHAT_PATTERN, CreateChatMessageDto, CreateDirectChatDto, EVENTS, GetChatMessageConversationDto, LeaveMember, RemoveMember, TransferOwnership, User } from '@app/contracts';
import type { AddMemberEventPayload, CreateTeamEventPayload, RemoveMemberEventPayload, TransferOwnershipEventPayload } from '@app/contracts'
...
export class ChatController {
  ...
  getMessagesForConversation(payload: GetChatMessageConversationDto) {
    ...
    return this.chatService.getMessagesForConversation(userId, conversationId, page, limit);
  }
}
