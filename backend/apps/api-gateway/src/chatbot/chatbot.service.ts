import { CHATBOT_CLIENT } from '@app/contracts/constants';
...
export class ChatbotService {
    ...
    processDocument(fileName: string, userId: string) {
        ...
        this.chatbotClient.emit(CHATBOT_PATTERN.PROCESS_DOCUMENT, { fileName, userId });
        return { message: 'Tài liệu của bạn đã được tiếp nhận và đang được xử lý.' };
    }
