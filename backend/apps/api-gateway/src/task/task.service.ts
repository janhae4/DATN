...
export class TaskService {
  ...
  async generateFromMessage(
    ...
    console.log(`[TaskService.generateFromMessage] Sending request. Payload:`, { userId, messageId, teamId, projectId, sprintId });
    try {
      ...
      console.log(`[TaskService.generateFromMessage] Received response:`, JSON.stringify(response).substring(0, 500));
      return response;
    } catch (error) {
      console.error(`[TaskService.generateFromMessage] Error:`, error);
      throw error;
    }
  }
}