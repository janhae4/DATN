...
const auth_service_1 = __webpack_require__(/*! ./auth.service */ "./apps/auth/src/auth/auth.service.ts");
...
const rabbitmq_decorators_1 = __webpack_require__(/*! @golevelup/nestjs-rabbitmq/lib/rabbitmq.decorators */ "@golevelup/nestjs-rabbitmq/lib/rabbitmq.decorators");
...
__decorate([
    (0, nestjs_rabbitmq_1.RabbitRPC)({
        ...
        queue: contracts_1.AUTH_PATTERN.REGISTER,
...
__decorate([
    (0, nestjs_rabbitmq_1.RabbitRPC)({
        ...
        queue: contracts_1.AUTH_PATTERN.VALIDATE_TOKEN,
        errorHandler: common_2.customErrorHandler
    }),
    __metadata("design:type", Function),
...
__decorate([
    (0, nestjs_rabbitmq_1.RabbitRPC)({
        ...
        queue: contracts_1.AUTH_PATTERN.VERIFY_LOCAL,
        errorHandler: common_2.customErrorHandler
    }),
    __metadata("design:type", Function),
...
__decorate([
    (0, nestjs_rabbitmq_1.RabbitRPC)({
        ...
        queue: contracts_1.AUTH_PATTERN.VERIFY_LOCAL_TOKEN,
        errorHandler: common_2.customErrorHandler
    }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], AuthController.prototype, "verifyLocalToken", null);
__decorate([
    (0, nestjs_rabbitmq_1.RabbitRPC)({
        exchange: contracts_1.AUTH_EXCHANGE,
        routingKey: contracts_1.AUTH_PATTERN.VERIFY_FORGOT_PASSWORD,
        queue: contracts_1.AUTH_PATTERN.VERIFY_FORGOT_PASSWORD,
        errorHandler: common_2.customErrorHandler
    }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_c = typeof contracts_1.ConfirmResetPasswordDto !== "undefined" && contracts_1.ConfirmResetPasswordDto) === "function" ? _c : Object]),
    __metadata("design:returntype", void 0)
...
__decorate([
    (0, nestjs_rabbitmq_1.RabbitRPC)({
        ...
        queue: contracts_1.AUTH_PATTERN.VERIFY_FORGOT_PASSWORD_TOKEN,
        errorHandler: common_2.customErrorHandler
    }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], AuthController.prototype, "verifyForgotPasswordToken", null);
__decorate([
    (0, nestjs_rabbitmq_1.RabbitRPC)({
        exchange: contracts_1.AUTH_EXCHANGE,
        routingKey: contracts_1.AUTH_PATTERN.RESET_CODE,
        queue: contracts_1.AUTH_PATTERN.RESET_CODE,
        errorHandler: common_2.customErrorHandler
    }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
...
__decorate([
    (0, nestjs_rabbitmq_1.RabbitRPC)({
        ...
        queue: contracts_1.AUTH_PATTERN.RESET_VERIFICATION_CODE,
        errorHandler: common_2.customErrorHandler
    }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], AuthController.prototype, "resetVerificationCode", null);
__decorate([
    (0, nestjs_rabbitmq_1.RabbitRPC)({
        exchange: contracts_1.AUTH_EXCHANGE,
        routingKey: contracts_1.AUTH_PATTERN.LOGIN,
        queue: contracts_1.AUTH_PATTERN.LOGIN,
        errorHandler: common_2.customErrorHandler
    }),
    __param(0, (0, rabbitmq_decorators_1.RabbitPayload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_d = typeof contracts_1.LoginDto !== "undefined" && contracts_1.LoginDto) === "function" ? _d : Object]),
    __metadata("design:returntype", Promise)
], AuthController.prototype, "login", null);
__decorate([
    (0, nestjs_rabbitmq_1.RabbitRPC)({
        exchange: contracts_1.AUTH_EXCHANGE,
        routingKey: contracts_1.AUTH_PATTERN.INFO,
        queue: contracts_1.AUTH_PATTERN.INFO,
        errorHandler: common_2.customErrorHandler
    }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
...
__decorate([
    (0, nestjs_rabbitmq_1.RabbitRPC)({
        ...
        queue: contracts_1.AUTH_PATTERN.CHANGE_PASSWORD,
        errorHandler: common_2.customErrorHandler
    }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_e = typeof contracts_1.ChangePasswordDto !== "undefined" && contracts_1.ChangePasswordDto) === "function" ? _e : Object]),
    __metadata("design:returntype", void 0)
...
__decorate([
    (0, nestjs_rabbitmq_1.RabbitRPC)({
        ...
        queue: contracts_1.AUTH_PATTERN.GOOGLE_CALLBACK,
        errorHandler: common_2.customErrorHandler
    }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_f = typeof contracts_1.GoogleAccountDto !== "undefined" && contracts_1.GoogleAccountDto) === "function" ? _f : Object]),
    __metadata("design:returntype", void 0)
...
__decorate([
    (0, nestjs_rabbitmq_1.RabbitRPC)({
        ...
        queue: contracts_1.AUTH_PATTERN.REFRESH,
        errorHandler: common_2.customErrorHandler
    }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
...
__decorate([
    (0, nestjs_rabbitmq_1.RabbitRPC)({
        exchange: contracts_1.AUTH_EXCHANGE,
        routingKey: contracts_1.AUTH_PATTERN.LOGOUT,
        queue: contracts_1.AUTH_PATTERN.LOGOUT,
        errorHandler: common_2.customErrorHandler
    }),
    __param(0, (0, rabbitmq_decorators_1.RabbitPayload)()),
    __metadata("design:type", Function),
...
__decorate([
    (0, nestjs_rabbitmq_1.RabbitRPC)({
        exchange: contracts_1.AUTH_EXCHANGE,
        routingKey: contracts_1.AUTH_PATTERN.LOGOUT_ALL,
        queue: contracts_1.AUTH_PATTERN.LOGOUT_ALL,
        errorHandler: common_2.customErrorHandler
    }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
...
__decorate([
    (0, nestjs_rabbitmq_1.RabbitRPC)({
        ...
        queue: contracts_1.AUTH_PATTERN.FORGET_PASSWORD,
        errorHandler: common_2.customErrorHandler
    }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_g = typeof contracts_1.ForgotPasswordDto !== "undefined" && contracts_1.ForgotPasswordDto) === "function" ? _g : Object]),
    __metadata("design:returntype", Promise)
...
const auth_controller_1 = __webpack_require__(/*! ./auth.controller */ "./apps/auth/src/auth/auth.controller.ts");
const auth_service_1 = __webpack_require__(/*! ./auth.service */ "./apps/auth/src/auth/auth.service.ts");
const contracts_1 = __webpack_require__(/*! @app/contracts */ "./libs/contracts/src/index.ts");
            ...
            nestjs_rabbitmq_1.RabbitMQModule.forRootAsync({
                ...
                useFactory: (cfg) => ({
                    exchanges: [
                        ...
                        {
                            name: contracts_1.GMAIL_EXCHANGE,
                            type: 'direct',
                        },
                        {
...
let AuthService = AuthService_1 = class AuthService {
    ...
    constructor(jwtService, amqp) {
        this.jwtService = jwtService;
        this.amqp = amqp;
    }
    async register(createAuthDto) {
        this.logger.log(`Starting registration for user: ${createAuthDto.email}...`);
        const user = await (0, common_2.unwrapRpcResult)(await this.amqp.request({
        ...
        this.amqp.publish(contracts_1.EVENTS_EXCHANGE, contracts_1.EVENTS.REGISTER, user);
        this.logger.log(`Generating verification code for user ${user.id}.`);
        const { code, url } = await this.generateAndSendCode(user.verifiedCode ?? '', user.expiredCode ?? new Date(), 'verify', contracts_1.GMAIL_PATTERNS.SEND_VERIFICATION_EMAIL, user);
    ...
    verifyForgotPassword(userId, code, password) {
    ...
    async verifyForgotPasswordToken(token, password) {
        this.logger.log('Verifying forgot password via token...');
        const payload = await this.verifyToken(token);
        if (!payload)
            throw new common_1.UnauthorizedException('Invalid token');
        this.logger.log(`Token validated. Verifying forgot password for user ${payload.userId}...`);
        const { userId, code } = payload;
        return await this.amqp.request({
            exchange: contracts_1.USER_EXCHANGE,
            routingKey: contracts_1.USER_PATTERNS.VERIFY_FORGET_PASSWORD,
    ...
    async generateAndSendCode(code, expiredCode, typeCode, pattern, user) {
        this.logger.log(`Generating JWT for ${typeCode} code for user ${user.id}...`);
        const tokenPayload = {
            id: user.id,
            name: user.name,
            avatar: user.avatar,
        ...
        this.amqp.publish(contracts_1.GMAIL_EXCHANGE, pattern, emailPayload);
        return { code, url };
    }
    async resetCode(id) {
        this.logger.log(`Resetting password code for user ${id}...`);
        const payload = await this.amqp.request({
            exchange: contracts_1.USER_EXCHANGE,
            routingKey: contracts_1.USER_PATTERNS.RESET_CODE,
            payload: id,
        });
        this.logger.log(`Generating new reset code email for user ${payload.user.id}.`);
        const { code, url } = await this.generateAndSendCode(payload.code, payload.expiredCode, 'reset', contracts_1.GMAIL_PATTERNS.SEND_RESET_PASSWORD_EMAIL, payload.user);
        return {
            resetUrl: url,
            resetCode: code,
        };
    ...
    async resetVerificationCode(userId) {
        ...
        this.logger.log(`Generating new verification code email for user ${payload.user.id}.`);
        const { code, url } = await this.generateAndSendCode(payload.code, payload.expiredCode, 'verify', contracts_1.GMAIL_PATTERNS.SEND_VERIFICATION_EMAIL, payload.user);
        return {
            verificationUrl: url,
            verificationCode: code,
        };
    }
    async _generateTokensAndSession(user) {
        const sessionId = (0, crypto_1.randomUUID)();
        const payload = { id: user.id, role: user.role };
        this.logger.log(`Generating tokens for user ${user.id}, session ${sessionId}...`);
        const [accessToken, refreshToken] = await Promise.all([
            this.jwtService.signAsync(payload, { expiresIn: '1h' }),
            this.jwtService.signAsync({ ...payload, sessionId }, { expiresIn: contracts_1.REFRESH_TTL }),
        ]);
        const hashedRefresh = await bcrypt.hash(refreshToken, 10);
        this.amqp.publish(contracts_1.REDIS_EXCHANGE, contracts_1.REDIS_PATTERN.STORE_REFRESH_TOKEN, {
            userId: user.id,
            sessionId,
            hashedRefresh,
            exp: contracts_1.REFRESH_TTL,
        });
        return { accessToken, refreshToken };
    }
    _handlePostLoginTasks(user) {
        this.logger.log(`Emitting post-login events for user ${user.id}.`);
        this.amqp.publish(contracts_1.EVENTS_EXCHANGE, contracts_1.EVENTS.LOGIN, user);
    }
    async login(loginDto) {
        this.logger.log(`Login attempt for ${loginDto.username}...`);
        const user = await this.amqp.request({
            exchange: contracts_1.USER_EXCHANGE,
    ...
    async handleLinking(data, account) {
        ...
        if (!user) {
            ...
            throw new common_1.UnauthorizedException('You must be logged in to link a provider');
        }
        this.logger.log(`Attempting to link ${provider} for user ${user.id} (Email: ${email}).`);
        if (account) {
            this.logger.warn(`Google account ${email} already linked to another user.`);
            throw new contracts_1.BadRequestException('Google account already linked');
        }
        const currentUser = await this.amqp.request({
            exchange: contracts_1.USER_EXCHANGE,
            routingKey: contracts_1.USER_PATTERNS.FIND_ONE,
            payload: user,
        });
        this.logger.log(`Storing Google tokens for user ${user.id}.`);
        this.amqp.publish(contracts_1.REDIS_EXCHANGE, contracts_1.REDIS_PATTERN.STORE_GOOGLE_TOKEN, {
            userId: user.id,
            accessToken,
            refreshToken,
        });
        ...
        this.logger.log(`Google account ${email} linked successfully to user ${user.id}.`);
        return { message: 'Google account linked successfully' };
    }
    async handleLoginGoogle(data, account) {
        this.logger.log(`Handling Google login for existing user ${account.user.id} (Email: ${data.email}).`);
    ...
    async handleRegisterGoogle(data) {
        this.logger.log(`Handling Google registration for new user (Email: ${data.email}).`);
    ...
    async handleGoogleCallback(data) {
        this.logger.log(`Processing Google callback for ${data.email} (Provider: ${data.provider}).`);
        if (!data.email) {
            this.logger.error('Google callback missing email.');
            throw new contracts_1.BadRequestException('Google account missing email');
        }
        const account = await this.amqp.request({
            exchange: contracts_1.USER_EXCHANGE,
    ...
    async refresh(token) {
        ...
        const payload = await this.verifyToken(token);
        this.logger.log(`Refresh payload validated for user ${payload.id}, session ${payload.sessionId}.`);
        const stored = await this.amqp.request({
        ...
        console.log(stored);
        if (!stored) {
            this.logger.warn(`No stored refresh token found for user ${payload.id}, session ${payload.sessionId}.`);
            throw new common_1.UnauthorizedException('Invalid refresh token');
        }
        this.logger.log('Comparing token hashes...');
        const matches = await bcrypt.compare(token, stored.token);
        if (!matches) {
            this.logger.warn(`Refresh token hash mismatch for user ${payload.id}, session ${payload.sessionId}.`);
            throw new common_1.UnauthorizedException('Invalid refresh token');
        }
        this.logger.log(`Attempting to acquire refresh lock for user ${payload.id}, session ${payload.sessionId}...`);
        const lockKey = await this.amqp.request({
            exchange: contracts_1.REDIS_EXCHANGE,
        ...
        if (!lockKey) {
            this.logger.warn(`Refresh lock failed (already in progress) for user ${payload.id}, session ${payload.sessionId}.`);
        ...
        this.logger.log(`Refresh lock acquired. Generating new tokens for user ${payload.id}.`);
        this.amqp.publish(contracts_1.REDIS_EXCHANGE, contracts_1.REDIS_PATTERN.DELETE_REFRESH_TOKEN, {
            userId: payload.id,
            sessionId: payload.sessionId,
        });
    ...
    changePassword(changePasswordDto) {
        this.logger.log(`Processing password change for user ${changePasswordDto.id}...`);
        const user = this.amqp.request({
            exchange: contracts_1.USER_EXCHANGE,
        ...
        if (!user) {
            ...
            throw new contracts_1.NotFoundException(`User ${changePasswordDto.id} not found.`);
        }
        this.amqp.publish(contracts_1.GMAIL_EXCHANGE, contracts_1.GMAIL_PATTERNS.SEND_EMAIL_PASSWORD_CHANGE, user);
    ...
    async forgetPassword(forgotPasswordDto) {
        ...
        try {
            ...
            if (!payload.user) {
                this.logger.warn(`Forgot password attempt for non-existent account: ${forgotPasswordDto.email}`);
                throw new contracts_1.NotFoundException('Account not found');
            }
            const { user, resetCode, expiredCode } = payload;
            this.logger.log(`User ${user.id} found. Generating password reset code...`);
            const { code, url } = await this.generateAndSendCode(resetCode, expiredCode, 'reset', contracts_1.GMAIL_PATTERNS.SEND_RESET_PASSWORD_EMAIL, user);
            return {
                resetUrl: url,
                resetCode: code,
            };
            ...
            const err = error;
            this.logger.error(`Failed to process forgot password for ${forgotPasswordDto.email}: ${err.message}`);
            throw error;
        }
    }
    logoutAll(userId) {
        this.logger.log(`Logging out all sessions for user ${userId}...`);
        return this.amqp.publish(contracts_1.REDIS_EXCHANGE, contracts_1.REDIS_PATTERN.CLEAR_REFRESH_TOKENS, {
            userId,
        });
    }
    async logout(token) {
        ...
        this.logger.log(`Deleting refresh token for user ${userId}, session ${sessionId}.`);
        return this.amqp.publish(contracts_1.REDIS_EXCHANGE, contracts_1.REDIS_PATTERN.DELETE_REFRESH_TOKEN, {
            userId,
            sessionId,
        });
    }
...
exports.AuthService = AuthService = AuthService_1 = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof jwt_1.JwtService !== "undefined" && jwt_1.JwtService) === "function" ? _a : Object, typeof (_b = typeof nestjs_rabbitmq_1.AmqpConnection !== "undefined" && nestjs_rabbitmq_1.AmqpConnection) === "function" ? _b : Object])
], AuthService);
...
/***/ "@golevelup/nestjs-rabbitmq/lib/rabbitmq.decorators":
/*!*********************************************************************!*\
  !*** external "@golevelup/nestjs-rabbitmq/lib/rabbitmq.decorators" ***!
  \*********************************************************************/
/***/ ((module) => {

module.exports = require("@golevelup/nestjs-rabbitmq/lib/rabbitmq.decorators");
...
const auth_module_1 = __webpack_require__(/*! ./auth/auth.module */ "./apps/auth/src/auth/auth.module.ts");
