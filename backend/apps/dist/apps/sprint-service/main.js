...
/***/ "./apps/sprint-service/src/sprint-service.module.ts":
/*!**********************************************************!*\
  !*** ./apps/sprint-service/src/sprint-service.module.ts ***!
  \**********************************************************/
...
exports.SprintServiceModule = void 0;
const common_1 = __webpack_require__(/*! @nestjs/common */ "@nestjs/common");
const sprints_module_1 = __webpack_require__(/*! ./sprints/sprints.module */ "./apps/sprint-service/src/sprints/sprints.module.ts");
...
let SprintRabbitMQModule = class SprintRabbitMQModule {
};
SprintRabbitMQModule = __decorate([
    (0, common_2.Global)(),
    (0, common_1.Module)({
        imports: [
...
let SprintServiceModule = class SprintServiceModule {
};
exports.SprintServiceModule = SprintServiceModule;
exports.SprintServiceModule = SprintServiceModule = __decorate([
    (0, common_1.Module)({
        imports: [
            ...
            typeorm_1.TypeOrmModule.forRootAsync({
                ...
                useFactory: (configService) => ({
                    ...
                    entities: [contracts_1.Sprint],
                    synchronize: true,
                }),
            }),
            typeorm_1.TypeOrmModule.forFeature([contracts_1.Sprint]),
...
/***/ "./apps/sprint-service/src/sprints/sprints.controller.ts":
/*!***************************************************************!*\
  !*** ./apps/sprint-service/src/sprints/sprints.controller.ts ***!
  \***************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const sprints_service_1 = __webpack_require__(/*! ./sprints.service */ "./apps/sprint-service/src/sprints/sprints.service.ts");
const contracts_1 = __webpack_require__(/*! @app/contracts */ "./libs/contracts/src/index.ts");
...
__decorate([
    (0, microservices_1.MessagePattern)(contracts_1.SPRINT_PATTERNS.CREATE),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_b = typeof contracts_1.CreateSprintDto !== "undefined" && contracts_1.CreateSprintDto) === "function" ? _b : Object]),
    __metadata("design:returntype", void 0)
], SprintsController.prototype, "create", null);
__decorate([
    (0, microservices_1.MessagePattern)(contracts_1.SPRINT_PATTERNS.FIND_ALL_BY_PROJECT_ID),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], SprintsController.prototype, "findAllByProjectId", null);
__decorate([
    (0, microservices_1.MessagePattern)(contracts_1.SPRINT_PATTERNS.FIND_ONE_BY_ID),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], SprintsController.prototype, "findOneById", null);
__decorate([
    (0, microservices_1.MessagePattern)(contracts_1.SPRINT_PATTERNS.UPDATE),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], SprintsController.prototype, "update", null);
__decorate([
    (0, microservices_1.MessagePattern)(contracts_1.SPRINT_PATTERNS.REMOVE),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
...
exports.SprintsController = SprintsController = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof sprints_service_1.SprintsService !== "undefined" && sprints_service_1.SprintsService) === "function" ? _a : Object])
], SprintsController);


/***/ }),

/***/ "./apps/sprint-service/src/sprints/sprints.module.ts":
/*!***********************************************************!*\
  !*** ./apps/sprint-service/src/sprints/sprints.module.ts ***!
  \***********************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const common_1 = __webpack_require__(/*! @nestjs/common */ "@nestjs/common");
const sprints_controller_1 = __webpack_require__(/*! ./sprints.controller */ "./apps/sprint-service/src/sprints/sprints.controller.ts");
const sprints_service_1 = __webpack_require__(/*! ./sprints.service */ "./apps/sprint-service/src/sprints/sprints.service.ts");
const typeorm_1 = __webpack_require__(/*! @nestjs/typeorm */ "@nestjs/typeorm");
const sprint_entity_1 = __webpack_require__(/*! @app/contracts/sprint/entity/sprint.entity */ "./libs/contracts/src/sprint/entity/sprint.entity.ts");
let SprintsModule = class SprintsModule {
};
exports.SprintsModule = SprintsModule;
exports.SprintsModule = SprintsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([sprint_entity_1.Sprint])],
...
/***/ "./apps/sprint-service/src/sprints/sprints.service.ts":
/*!************************************************************!*\
  !*** ./apps/sprint-service/src/sprints/sprints.service.ts ***!
  \************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
let SprintsService = class SprintsService {
    sprintRepository;
    amqpConnection;
    constructor(sprintRepository, amqpConnection) {
    ...
    async update(id, updateSprintDto) {
        ...
        if (updateSprintDto.status === contracts_1.SprintStatus.COMPLETED) {
            this.amqpConnection.publish(contracts_1.TASK_EXCHANGE, contracts_1.TASK_PATTERNS.MOVE_INCOMPLETE_TASKS_TO_BACKLOG, { sprintId: id });
        }
    ...
    async remove(id) {
        await this.findOneById(id);
        this.amqpConnection.publish(contracts_1.TASK_EXCHANGE, contracts_1.TASK_PATTERNS.UNASSIGN_TASKS_FROM_SPRINT, {
            sprintId: id,
        });
    ...
    async getActiveSprint(projectId) {
        return this.sprintRepository.findOne({
            where: {
                projectId,
                status: contracts_1.SprintStatus.ACTIVE,
            },
        });
    }
    async startSprint(id) {
        ...
        if (activeSprint) {
            throw new common_1.BadRequestException('An active sprint already exists in this project. Complete it before starting a new one.');
        }
        await this.sprintRepository.update(id, { status: contracts_1.SprintStatus.ACTIVE });
        return this.findOneById(id);
    }
};
...
/*!*****************************************!*\
  !*** ./apps/sprint-service/src/main.ts ***!
  \*****************************************/

Object.defineProperty(exports, "__esModule", ({ value: true }));
const core_1 = __webpack_require__(/*! @nestjs/core */ "@nestjs/core");
const sprint_service_module_1 = __webpack_require__(/*! ./sprint-service.module */ "./apps/sprint-service/src/sprint-service.module.ts");
const common_1 = __webpack_require__(/*! @nestjs/common */ "@nestjs/common");
const contracts_1 = __webpack_require__(/*! @app/contracts */ "./libs/contracts/src/index.ts");
async function bootstrap() {
    const appContext = await core_1.NestFactory.create(sprint_service_module_1.SprintServiceModule);
    const configService = appContext.get(contracts_1.ClientConfigService);
    appContext.connectMicroservice(configService.sprintClientOptions);
    await appContext.startAllMicroservices();
    await appContext.init();
    common_1.Logger.log('Sprint Service is listening RabbitMQ messages...', 'Bootstrap');
}
bootstrap();
