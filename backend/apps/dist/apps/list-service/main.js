...
/***/ "./apps/list-service/src/list/list.controller.ts":
/*!*******************************************************!*\
  !*** ./apps/list-service/src/list/list.controller.ts ***!
  \*******************************************************/
...
const list_service_1 = __webpack_require__(/*! ./list.service */ "./apps/list-service/src/list/list.service.ts");
const contracts_1 = __webpack_require__(/*! @app/contracts */ "./libs/contracts/src/index.ts");
const microservices_1 = __webpack_require__(/*! @nestjs/microservices */ "@nestjs/microservices");
const project_events_1 = __webpack_require__(/*! @app/contracts/events/project.events */ "./libs/contracts/src/events/project.events.ts");
...
__decorate([
    (0, microservices_1.MessagePattern)(contracts_1.LIST_PATTERNS.CREATE),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_b = typeof contracts_1.CreateListDto !== "undefined" && contracts_1.CreateListDto) === "function" ? _b : Object]),
    __metadata("design:returntype", void 0)
], ListController.prototype, "create", null);
__decorate([
    (0, microservices_1.MessagePattern)(contracts_1.LIST_PATTERNS.FIND_ALL_BY_PROJECT_ID),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], ListController.prototype, "findAllByProjectId", null);
__decorate([
    (0, microservices_1.MessagePattern)(contracts_1.LIST_PATTERNS.FIND_ONE_BY_ID),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], ListController.prototype, "findOneById", null);
__decorate([
    (0, microservices_1.MessagePattern)(contracts_1.LIST_PATTERNS.UPDATE),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], ListController.prototype, "update", null);
__decorate([
    (0, microservices_1.MessagePattern)(contracts_1.LIST_PATTERNS.REMOVE),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], ListController.prototype, "remove", null);
__decorate([
    (0, microservices_1.EventPattern)(project_events_1.PROJECT_EVENTS.PROJECT_CREATED),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], ListController.prototype, "handleProjectCreated", null);
...
/***/ "./apps/list-service/src/list/list.module.ts":
/*!***************************************************!*\
  !*** ./apps/list-service/src/list/list.module.ts ***!
  \***************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const common_1 = __webpack_require__(/*! @nestjs/common */ "@nestjs/common");
const list_controller_1 = __webpack_require__(/*! ./list.controller */ "./apps/list-service/src/list/list.controller.ts");
const list_service_1 = __webpack_require__(/*! ./list.service */ "./apps/list-service/src/list/list.service.ts");
const typeorm_1 = __webpack_require__(/*! @nestjs/typeorm */ "@nestjs/typeorm");
const list_entity_1 = __webpack_require__(/*! @app/contracts/list/list/list.entity */ "./libs/contracts/src/list/list/list.entity.ts");
...
/***/ "./apps/list-service/src/list/list.service.ts":
/*!****************************************************!*\
  !*** ./apps/list-service/src/list/list.service.ts ***!
  \****************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
    ...
    createDefaultLists(projectId) {
        const defaultLists = [
            { name: 'To Do', projectId, position: 1 },
            {
                ...
                projectId,
                position: 2,
                category: contracts_1.ListCategoryEnum.IN_PROGRESS,
            },
            { name: 'Done', projectId, position: 3, category: contracts_1.ListCategoryEnum.DONE },
        ];
...
/***/ "./apps/list-service/src/lists-service.module.ts":
/*!*******************************************************!*\
  !*** ./apps/list-service/src/lists-service.module.ts ***!
  \*******************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.ListServiceModule = void 0;
const common_1 = __webpack_require__(/*! @nestjs/common */ "@nestjs/common");
const list_module_1 = __webpack_require__(/*! ./list/list.module */ "./apps/list-service/src/list/list.module.ts");
const nestjs_rabbitmq_1 = __webpack_require__(/*! @golevelup/nestjs-rabbitmq */ "@golevelup/nestjs-rabbitmq");
const contracts_1 = __webpack_require__(/*! @app/contracts */ "./libs/contracts/src/index.ts");
const typeorm_1 = __webpack_require__(/*! @nestjs/typeorm */ "@nestjs/typeorm");
const list_entity_1 = __webpack_require__(/*! @app/contracts/list/list/list.entity */ "./libs/contracts/src/list/list/list.entity.ts");
let ListServiceModule = class ListServiceModule {
};
exports.ListServiceModule = ListServiceModule;
exports.ListServiceModule = ListServiceModule = __decorate([
    (0, common_1.Module)({
        imports: [
...
/***/ "./libs/contracts/src/events/project.events.ts":
/*!*****************************************************!*\
  !*** ./libs/contracts/src/events/project.events.ts ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, exports) => {
...
exports.PROJECT_EVENTS = {
    PROJECT_CREATED: 'project.created.event',
    PROJECT_UPDATED: 'project.updated.event',
    PROJECT_DELETED: 'project.deleted.event',
};
...
/***/ "./libs/contracts/src/list/list/list.entity.ts":
/*!*****************************************************!*\
  !*** ./libs/contracts/src/list/list/list.entity.ts ***!
  \*****************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.List = void 0;
const list_category_enum_1 = __webpack_require__(/*! @app/contracts/enums/list-category.enum */ "./libs/contracts/src/enums/list-category.enum.ts");
const typeorm_1 = __webpack_require__(/*! typeorm */ "typeorm");
let List = class List {
    id;
    name;
...
__decorate([
    ...
    __metadata("design:type", String)
], List.prototype, "projectId", void 0);
__decorate([
    (0, typeorm_1.Column)({ type: 'int', nullable: true }),
    __metadata("design:type", Number)
], List.prototype, "limited", void 0);
__decorate([
    (0, typeorm_1.Column)({
        type: 'enum',
        enum: list_category_enum_1.ListCategoryEnum,
...
__decorate([
    ...
    __metadata("design:type", Boolean)
], List.prototype, "isArchived", void 0);
__decorate([
    (0, typeorm_1.CreateDateColumn)({ name: 'created_at', type: 'varchar' }),
    __metadata("design:type", typeof (_b = typeof Date !== "undefined" && Date) === "function" ? _b : Object)
], List.prototype, "createdAt", void 0);
__decorate([
    (0, typeorm_1.UpdateDateColumn)({ name: 'updated_at', type: 'varchar' }),
    __metadata("design:type", typeof (_c = typeof Date !== "undefined" && Date) === "function" ? _c : Object)
...
const common_1 = __webpack_require__(/*! @nestjs/common */ "@nestjs/common");
const contracts_1 = __webpack_require__(/*! @app/contracts */ "./libs/contracts/src/index.ts");
const lists_service_module_1 = __webpack_require__(/*! ./lists-service.module */ "./apps/list-service/src/lists-service.module.ts");
async function bootstrap() {
    const appContext = await core_1.NestFactory.create(lists_service_module_1.ListServiceModule);
    const configService = appContext.get(contracts_1.ClientConfigService);
    appContext.connectMicroservice(configService.listClientOptions);
    await appContext.startAllMicroservices();
    await appContext.init();
    common_1.Logger.log('List Service is listening RabbitMQ messages...', 'Bootstrap');
}
bootstrap();
