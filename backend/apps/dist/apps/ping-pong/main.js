...
/***/ "./apps/ping-pong/src/ping-pong.controller.ts":
/*!****************************************************!*\
  !*** ./apps/ping-pong/src/ping-pong.controller.ts ***!
  \****************************************************/
...
const ping_pong_service_1 = __webpack_require__(/*! ./ping-pong.service */ "./apps/ping-pong/src/ping-pong.service.ts");
let PingPongController = PingPongController_1 = class PingPongController {
    pingPongService;
    logger = new common_1.Logger(PingPongController_1.name);
    constructor(pingPongService) {
        this.pingPongService = pingPongService;
    }
    async handlePing(payload) {
        console.log('Received ping request in service:', payload);
        this.logger.log(`Received Ping: ${JSON.stringify(payload)}`);
        return this.pingPongService.replyPong(payload);
    }
};
exports.PingPongController = PingPongController;
__decorate([
    (0, nestjs_rabbitmq_1.RabbitRPC)({
        exchange: 'ping_pong_exchange',
        routingKey: 'ping.request',
        queue: 'ping_pong_queue',
    }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], PingPongController.prototype, "handlePing", null);
exports.PingPongController = PingPongController = PingPongController_1 = __decorate([
    (0, common_1.Controller)(),
    __metadata("design:paramtypes", [typeof (_a = typeof ping_pong_service_1.PingPongService !== "undefined" && ping_pong_service_1.PingPongService) === "function" ? _a : Object])
], PingPongController);


/***/ }),

/***/ "./apps/ping-pong/src/ping-pong.module.ts":
/*!************************************************!*\
  !*** ./apps/ping-pong/src/ping-pong.module.ts ***!
  \************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const ping_pong_controller_1 = __webpack_require__(/*! ./ping-pong.controller */ "./apps/ping-pong/src/ping-pong.controller.ts");
const ping_pong_service_1 = __webpack_require__(/*! ./ping-pong.service */ "./apps/ping-pong/src/ping-pong.service.ts");
...
/***/ "./apps/ping-pong/src/ping-pong.service.ts":
/*!*************************************************!*\
  !*** ./apps/ping-pong/src/ping-pong.service.ts ***!
  \*************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
let PingPongService = class PingPongService {
    replyPong(payload) {
        console.log('in PingPongService.replyPong with payload:', payload);
        ...
        return {
            ...
            latencyMs: latency,
            status: 'RabbitMQ connection is healthy',
        };
    }
};
...
let ClientConfigService = class ClientConfigService {
    ...
    getProjectClientQueue() {
        return this.config.get('STATUS_QUEUE', 'status_service_queue');
    }
...
__decorate([
    ...
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], CreateListDto.prototype, "color", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'ALPHA' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ enum: project_visibility_enum_1.ProjectVisibility, example: project_visibility_enum_1.ProjectVisibility.TEAM }),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: ['11111111-2222-3333-4444-555555555555', '66666666-7777-8888-9999-000000000000'] }),
    (0, class_validator_1.IsArray)(),
    (0, class_validator_1.IsString)({ each: true }),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", Array)
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: '11111111-2222-3333-4444-555555555555' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
...
/*!************************************!*\
  !*** ./apps/ping-pong/src/main.ts ***!
  \************************************/

Object.defineProperty(exports, "__esModule", ({ value: true }));
const core_1 = __webpack_require__(/*! @nestjs/core */ "@nestjs/core");
const ping_pong_module_1 = __webpack_require__(/*! ./ping-pong.module */ "./apps/ping-pong/src/ping-pong.module.ts");
async function bootstrap() {
    const app = await core_1.NestFactory.create(ping_pong_module_1.PingPongModule);
    await app.init();
    console.log('🏓 Ping-Pong Microservice is listening (RPC Mode)');
}
bootstrap();
