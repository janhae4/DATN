...
let UserController = class UserController {
    ...
    async updatePassword(updatePasswordDto) {
        return await this.userService.updatePassword(updatePasswordDto.id ?? '', updatePasswordDto.oldPassword, updatePasswordDto.newPassword);
    }
    update(data) {
...
__decorate([
    (0, nestjs_rabbitmq_1.RabbitSubscribe)({
        ...
        queue: contracts_1.EVENTS_USER_QUEUE,
        queueOptions: {
            durable: true,
        },
...
__decorate([
    (0, nestjs_rabbitmq_1.RabbitRPC)({
        ...
        queue: contracts_1.USER_PATTERNS.CREATE_LOCAL,
        errorHandler: common_2.customErrorHandler
    }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_c = typeof contracts_1.CreateAuthLocalDto !== "undefined" && contracts_1.CreateAuthLocalDto) === "function" ? _c : Object]),
    __metadata("design:returntype", void 0)
], UserController.prototype, "create", null);
__decorate([
    (0, nestjs_rabbitmq_1.RabbitRPC)({
        exchange: contracts_1.USER_EXCHANGE,
        routingKey: contracts_1.USER_PATTERNS.CREATE_OAUTH,
        queue: contracts_1.USER_PATTERNS.CREATE_OAUTH,
        errorHandler: common_2.customErrorHandler
    }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_d = typeof contracts_1.CreateAuthOAuthDto !== "undefined" && contracts_1.CreateAuthOAuthDto) === "function" ? _d : Object]),
    __metadata("design:returntype", void 0)
], UserController.prototype, "createOAuth", null);
__decorate([
    (0, nestjs_rabbitmq_1.RabbitRPC)({
        exchange: contracts_1.USER_EXCHANGE,
        routingKey: contracts_1.USER_PATTERNS.CREATE_ACCOUNT,
        queue: contracts_1.USER_PATTERNS.CREATE_ACCOUNT,
        errorHandler: common_2.customErrorHandler
    }),
    __metadata("design:type", Function),
...
__decorate([
    (0, nestjs_rabbitmq_1.RabbitRPC)({
        exchange: contracts_1.USER_EXCHANGE,
        routingKey: contracts_1.USER_PATTERNS.VERIFY_LOCAL,
        queue: contracts_1.USER_PATTERNS.VERIFY_LOCAL,
        errorHandler: common_2.customErrorHandler
    }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], UserController.prototype, "verifyLocal", null);
__decorate([
    (0, nestjs_rabbitmq_1.RabbitRPC)({
        exchange: contracts_1.USER_EXCHANGE,
        routingKey: contracts_1.USER_PATTERNS.VERIFY_FORGET_PASSWORD,
        queue: contracts_1.USER_PATTERNS.VERIFY_FORGET_PASSWORD,
        errorHandler: common_2.customErrorHandler
    }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], UserController.prototype, "verifyForgotPassword", null);
__decorate([
    (0, nestjs_rabbitmq_1.RabbitRPC)({
        exchange: contracts_1.USER_EXCHANGE,
        routingKey: contracts_1.USER_PATTERNS.RESET_CODE,
        queue: contracts_1.USER_PATTERNS.RESET_CODE,
        errorHandler: common_2.customErrorHandler
    }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], UserController.prototype, "resetCode", null);
__decorate([
    (0, nestjs_rabbitmq_1.RabbitRPC)({
        exchange: contracts_1.USER_EXCHANGE,
        routingKey: contracts_1.USER_PATTERNS.RESET_PASSWORD,
        queue: contracts_1.USER_PATTERNS.RESET_PASSWORD,
        errorHandler: common_2.customErrorHandler
    }),
    __metadata("design:type", Function),
...
__decorate([
    (0, nestjs_rabbitmq_1.RabbitRPC)({
        ...
        queue: contracts_1.USER_PATTERNS.FIND_ALL,
        errorHandler: common_2.customErrorHandler
    }),
    __metadata("design:type", Function),
...
__decorate([
    (0, nestjs_rabbitmq_1.RabbitRPC)({
        ...
        queue: contracts_1.USER_PATTERNS.FIND_ONE,
        errorHandler: common_2.customErrorHandler
    }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
...
__decorate([
    (0, nestjs_rabbitmq_1.RabbitRPC)({
        exchange: contracts_1.USER_EXCHANGE,
        routingKey: contracts_1.USER_PATTERNS.FIND_ONE_WITH_PASSWORD,
        queue: contracts_1.USER_PATTERNS.FIND_ONE_WITH_PASSWORD,
        errorHandler: common_2.customErrorHandler
    }),
    __param(0, (0, nestjs_rabbitmq_1.RabbitPayload)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
...
__decorate([
    (0, nestjs_rabbitmq_1.RabbitRPC)({
        exchange: contracts_1.USER_EXCHANGE,
        routingKey: contracts_1.USER_PATTERNS.FIND_ONE_GOOGLE_BY_EMAIL,
        queue: contracts_1.USER_PATTERNS.FIND_ONE_GOOGLE_BY_EMAIL,
        errorHandler: common_2.customErrorHandler
    }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], UserController.prototype, "findOneGoogle", null);
__decorate([
    (0, nestjs_rabbitmq_1.RabbitRPC)({
        exchange: contracts_1.USER_EXCHANGE,
        routingKey: contracts_1.USER_PATTERNS.FIND_ONE_BY_EMAIL,
        queue: contracts_1.USER_PATTERNS.FIND_ONE_BY_EMAIL,
        errorHandler: common_2.customErrorHandler
    }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
...
__decorate([
    (0, nestjs_rabbitmq_1.RabbitRPC)({
        exchange: contracts_1.USER_EXCHANGE,
        routingKey: contracts_1.USER_PATTERNS.FIND_ONE_OAUTH,
        queue: contracts_1.USER_PATTERNS.FIND_ONE_OAUTH,
        errorHandler: common_2.customErrorHandler
    }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], UserController.prototype, "findOneOAuth", null);
__decorate([
    (0, nestjs_rabbitmq_1.RabbitRPC)({
        exchange: contracts_1.USER_EXCHANGE,
        routingKey: contracts_1.USER_PATTERNS.FIND_MANY_BY_IDs,
        queue: contracts_1.USER_PATTERNS.FIND_MANY_BY_IDs,
        errorHandler: common_2.customErrorHandler
    }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], UserController.prototype, "findManyByIds", null);
__decorate([
    (0, nestjs_rabbitmq_1.RabbitRPC)({
        exchange: contracts_1.USER_EXCHANGE,
        routingKey: contracts_1.USER_PATTERNS.VALIDATE,
        queue: contracts_1.USER_PATTERNS.VALIDATE,
        errorHandler: common_2.customErrorHandler
    }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_f = typeof contracts_1.LoginDto !== "undefined" && contracts_1.LoginDto) === "function" ? _f : Object]),
    __metadata("design:returntype", Promise)
], UserController.prototype, "validate", null);
__decorate([
    (0, nestjs_rabbitmq_1.RabbitRPC)({
        exchange: contracts_1.USER_EXCHANGE,
        routingKey: contracts_1.USER_PATTERNS.UPDATE_PASSWORD,
        queue: contracts_1.USER_PATTERNS.UPDATE_PASSWORD,
        errorHandler: common_2.customErrorHandler
    }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_g = typeof contracts_1.ChangePasswordDto !== "undefined" && contracts_1.ChangePasswordDto) === "function" ? _g : Object]),
    __metadata("design:returntype", Promise)
...
__decorate([
    (0, nestjs_rabbitmq_1.RabbitRPC)({
        ...
        queue: contracts_1.USER_PATTERNS.UPDATE,
        errorHandler: common_2.customErrorHandler
    }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
...
__decorate([
    (0, nestjs_rabbitmq_1.RabbitRPC)({
        ...
        queue: contracts_1.USER_PATTERNS.REMOVE,
        errorHandler: common_2.customErrorHandler
    }),
    __param(0, (0, nestjs_rabbitmq_1.RabbitPayload)('id')),
    __metadata("design:type", Function),
...
__decorate([
    (0, nestjs_rabbitmq_1.RabbitRPC)({
        ...
        queue: contracts_1.USER_PATTERNS.FIND_MANY_BY_NAME,
        errorHandler: common_2.customErrorHandler
    }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_h = typeof contracts_1.FindUserDto !== "undefined" && contracts_1.FindUserDto) === "function" ? _h : Object]),
    __metadata("design:returntype", void 0)
...
__decorate([
    (0, nestjs_rabbitmq_1.RabbitRPC)({
        ...
        queue: contracts_1.USER_PATTERNS.FOLLOW,
        errorHandler: common_2.customErrorHandler
    }),
    __metadata("design:type", Function),
...
__decorate([
    (0, nestjs_rabbitmq_1.RabbitRPC)({
        ...
        queue: contracts_1.USER_PATTERNS.UNFOLLOW,
        errorHandler: common_2.customErrorHandler
    }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String]),
...
exports.UserModule = UserModule = __decorate([
    (0, common_1.Module)({
        imports: [
            ...
            typeorm_1.TypeOrmModule.forRootAsync({
                useFactory: () => ({
                    ...
                    entities: [contracts_1.User, contracts_1.Account, contracts_1.Follow],
                    synchronize: true,
                }),
            }),
            typeorm_1.TypeOrmModule.forFeature([contracts_1.User, contracts_1.Account, contracts_1.Follow]),
            nestjs_rabbitmq_1.RabbitMQModule.forRootAsync({
                ...
                useFactory: (config) => ({
                    exchanges: [
                        {
                            name: contracts_1.USER_EXCHANGE,
                            type: 'direct',
                        },
                        {
        ...
        providers: [user_service_1.UserService, user_controller_1.UserController],
    })
], UserModule);
...
const events_pattern_1 = __webpack_require__(/*! @app/contracts/events/events.pattern */ "./libs/contracts/src/events/events.pattern.ts");
const nestjs_rabbitmq_1 = __webpack_require__(/*! @golevelup/nestjs-rabbitmq */ "@golevelup/nestjs-rabbitmq");
const common_2 = __webpack_require__(/*! @app/common */ "./libs/common/src/index.ts");
let UserService = UserService_1 = class UserService {
    ...
    MIN_WAIT_TIME_MS = 60 * 1000;
    EXPIRY_TIME_MS = 15 * 60 * 1000;
    constructor(userRepo, accountRepo, followRepo, dataSource, amqp) {
    ...
    async createLocal(createUserDto) {
        return await this.dataSource.transaction(async (manager) => {
            ...
            const emailExistInUser = await manager.findOne(contracts_1.User, {
                where: { email },
            });
            if (emailExistInUser) {
                this.logger.warn(`Registration failed: Email ${email} already exists in User table.`);
                throw new contracts_1.ConflictException('This email is already in use');
            }
            const emailExistInAccount = await manager.findOne(contracts_1.Account, {
                where: { email },
            });
            ...
            const usernameExist = await manager.findOne(contracts_1.Account, {
                where: {
                    provider: contracts_1.Provider.LOCAL,
                    providerId: username,
                },
            });
            if (usernameExist) {
                this.logger.warn(`Registration failed: Username ${username} already exists.`);
                throw new contracts_1.ConflictException('This username is already in use');
            }
            const verifiedCode = (0, crypto_1.randomInt)(100000, 999999).toString();
            const expiredCode = new Date(Date.now() + 15 * 60 * 1000);
            const savedUser = manager.create(contracts_1.User, {
            ...
            const account = manager.create(contracts_1.Account, {
                provider: contracts_1.Provider.LOCAL,
    ...
    async verifyLocal(userId, code) {
        ...
        if (user.expiredCode && user.expiredCode < new Date()) {
            ...
            throw new contracts_1.BadRequestException('Verification code expired');
        }
    ...
    async verifyForgotPassword(userId, code, password) {
        ...
        if (!password)
            throw new contracts_1.BadRequestException('Password is required');
        if (!user.resetCode) {
        ...
        const account = user?.accounts.find((a) => a.provider === contracts_1.Provider.LOCAL);
        if (await bcrypt.compare(password, account.password ?? '')) {
            this.logger.warn(`Forgot password failed for user ${userId}: New password is the same as the old one.`);
            throw new contracts_1.BadRequestException('Password must be different from old password');
        }
    ...
    async resetCode(userId, typeCode) {
        return await this.dataSource.transaction(async (manager) => {
            this.logger.log(`Attempting to reset ${typeCode} code for user ID: ${userId}`);
            const user = await manager.findOne(contracts_1.User, {
                where: { id: userId },
            ...
            if (user.isVerified && typeCode === 'verify') {
                ...
                throw new contracts_1.BadRequestException('User already verified');
            }
            if (!user.resetCode && typeCode === 'reset') {
                this.logger.warn(`Code reset failed for user ${userId}: No reset code exists.`);
                throw new contracts_1.BadRequestException('There is no reset code for this user');
            }
            if (user.expiredCode && user.expiredCode > new Date()) {
                this.logger.warn(`Code reset failed for user ${userId}: Code not expired yet.`);
                throw new contracts_1.BadRequestException(`${typeCode === 'verify' ? 'Verification' : 'Reset'} code not expired`);
            }
            ...
            await manager.update(contracts_1.User, { id: userId }, updateData);
    ...
    async findOneOAuth(provider, providerId) {
    ...
    async findOneByEmailOrUserName(data) {
        this.logger.log(`Finding account by email or username: ${data}`);
        return await this.accountRepo.findOne({
            where: [{ email: data }, { providerId: data, provider: contracts_1.Provider.LOCAL }],
            relations: ['user'],
        });
    }
    async findOneGoogle(email) {
        ...
        return await this.accountRepo.findOne({
            where: { provider: contracts_1.Provider.GOOGLE, user: { email } },
            relations: ['user'],
        });
    }
    async findOneWithPassword(id) {
        ...
        return await this.accountRepo.findOne({
            where: { provider: contracts_1.Provider.LOCAL, user: { id } },
            relations: ['user'],
        });
    }
    async findManyByIds(ids, forDiscussion) {
        const cachedUsers = (0, common_2.unwrapRpcResult)(await this.amqp.request({
        ...
        if (missingIds.length > 0) {
            ...
            missingUsers = await this.userRepo.findBy({ id: (0, typeorm_2.In)(missingIds) });
            if (missingUsers.length > 0) {
                await this.amqp.publish(contracts_1.REDIS_EXCHANGE, contracts_1.REDIS_PATTERN.SET_MANY_USERS_INFO, missingUsers);
            }
        }
    ...
    async validate(loginDto) {
        ...
        const account = await this.accountRepo.findOne({
            where: [
                { provider: contracts_1.Provider.LOCAL, providerId: loginDto.username },
                { provider: contracts_1.Provider.LOCAL, email: loginDto.username },
            ],
            relations: ['user'],
        });
        console.log(account);
    ...
    async resetPassword(email) {
        return await this.dataSource.transaction(async (manager) => {
            ...
            if (!user) {
                ...
                throw new contracts_1.NotFoundException('Account not found');
            }
            const account = user.accounts.find((a) => a.provider === contracts_1.Provider.LOCAL);
            if (!account) {
                this.logger.warn(`Password reset failed: Local account not found for user ${user.id}.`);
                throw new contracts_1.NotFoundException('Local account not found');
            }
            const now = Date.now();
            ...
            if (user.resetCode && now < lastSentTime + this.MIN_WAIT_TIME_MS) {
                ...
                throw new contracts_1.BadRequestException(`Reset code already sent! Please wait ${timeRemaining} seconds`);
            }
            const resetCode = (0, crypto_1.randomInt)(100000, 1000000).toString();
            const expiredCode = new Date(now + this.EXPIRY_TIME_MS);
            await manager.update(contracts_1.User, { id: user.id }, {
                resetCode,
                expiredCode,
            });
    ...
    async confirmResetPassword(userId, code, password) {
        ...
        if (user?.resetCode !== code) {
            ...
            throw new contracts_1.BadRequestException('Invalid code');
        }
        if (user.expiredCode && user.expiredCode < new Date()) {
            this.logger.warn(`Password reset confirmation failed for user ${userId}: Code expired.`);
            throw new contracts_1.BadRequestException('Code expired');
        }
        if (await bcrypt.compare(password, account.password ?? '')) {
    ...
    async updatePassword(id, oldPassword, newPassword) {
        return await this.dataSource.transaction(async (manager) => {
            ...
            if (oldPassword === newPassword) {
                ...
                throw new contracts_1.BadRequestException('New password must be different from old password');
            }
            const user = await manager.findOne(contracts_1.User, {
                where: { id },
                relations: ['accounts'],
            ...
            if (!(await bcrypt.compare(oldPassword, account.password ?? ''))) {
                ...
                throw new contracts_1.BadRequestException('Old password is incorrect');
            }
            const hashedPassword = await bcrypt.hash(newPassword, 10);
            await manager.update(contracts_1.Account, { id: account.id }, { password: hashedPassword });
    ...
    async update(id, data) {
        ...
        if (user && isPublish) {
            ...
            this.amqp.publish(contracts_1.EVENTS_EXCHANGE, events_pattern_1.EVENTS.USER_UPDATED, userUpdated);
        }
        else {
    ...
    async findByName(name, options, requesterId, teamId) {
        ...
        let memberIds = [];
        if (teamId) {
            const team = await this.amqp.request({
        ...
        const qb = this.userRepo.createQueryBuilder("user")
            .leftJoin("user.accounts", "account", "account.provider = :provider", { provider: contracts_1.Provider.LOCAL })
    ...
    async ban(userId) {
        const updateResult = await this.userRepo
            ...
            .andWhere('role != :adminRole', { adminRole: contracts_1.Role.ADMIN })
            .execute();
        ...
        if (userToBan.role === contracts_1.Role.ADMIN) {
            throw new contracts_1.ForbiddenException('You cannot ban an admin');
        }
        throw new contracts_1.BadRequestException('User not found or not banable');
    }
    async unban(userId) {
        const updateResult = await this.userRepo
            .createQueryBuilder()
        ...
        if (userToUnban.role === contracts_1.Role.ADMIN) {
            throw new contracts_1.ForbiddenException('You cannot unban an admin');
        }
        throw new contracts_1.BadRequestException('User not found or not unbanable');
    }
};
exports.UserService = UserService;
exports.UserService = UserService = UserService_1 = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(contracts_1.User)),
    __param(1, (0, typeorm_1.InjectRepository)(contracts_1.Account)),
    __param(2, (0, typeorm_1.InjectRepository)(contracts_1.Follow)),
    __param(3, (0, typeorm_1.InjectDataSource)()),
    __metadata("design:paramtypes", [typeof (_a = typeof typeorm_2.Repository !== "undefined" && typeorm_2.Repository) === "function" ? _a : Object, typeof (_b = typeof typeorm_2.Repository !== "undefined" && typeorm_2.Repository) === "function" ? _b : Object, typeof (_c = typeof typeorm_2.Repository !== "undefined" && typeorm_2.Repository) === "function" ? _c : Object, typeof (_d = typeof typeorm_2.DataSource !== "undefined" && typeorm_2.DataSource) === "function" ? _d : Object, typeof (_e = typeof nestjs_rabbitmq_1.AmqpConnection !== "undefined" && nestjs_rabbitmq_1.AmqpConnection) === "function" ? _e : Object])
], UserService);
