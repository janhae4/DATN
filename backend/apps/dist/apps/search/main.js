...
/***/ "./apps/search/src/search/search.controller.ts":
/*!*****************************************************!*\
  !*** ./apps/search/src/search/search.controller.ts ***!
  \*****************************************************/
...
const search_service_1 = __webpack_require__(/*! ./search.service */ "./apps/search/src/search/search.service.ts");
...
let SearchController = class SearchController {
    ...
    handleNewMessage(payload) {
        console.log('EVENTS.NEW_MESSAGE (subscriber):', contracts_1.EVENTS.NEW_MESSAGE);
    ...
    async handleDeleteDocumentIndex(payload) {
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], SearchController.prototype, "handleNewMessage", null);
__decorate([
    (0, nestjs_rabbitmq_1.RabbitSubscribe)({
        exchange: contracts_1.EVENTS_EXCHANGE,
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], SearchController.prototype, "handleLeaveTeam", null);
__decorate([
    (0, nestjs_rabbitmq_1.RabbitSubscribe)({
        exchange: contracts_1.EVENTS_EXCHANGE,
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], SearchController.prototype, "handleRemoveTeam", null);
__decorate([
    (0, nestjs_rabbitmq_1.RabbitSubscribe)({
        exchange: contracts_1.EVENTS_EXCHANGE,
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], SearchController.prototype, "handleRemoveMember", null);
__decorate([
    (0, nestjs_rabbitmq_1.RabbitSubscribe)({
        exchange: contracts_1.EVENTS_EXCHANGE,
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], SearchController.prototype, "handleAddMember", null);
__decorate([
    (0, nestjs_rabbitmq_1.RabbitRPC)({
        exchange: contracts_1.SEARCH_EXCHANGE,
        routingKey: contracts_1.SEARCH_PATTERN.SEARCH_MESSAGE,
        queue: contracts_1.SEARCH_PATTERN.SEARCH_MESSAGE,
        errorHandler: common_2.customErrorHandler
    }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
...
__decorate([
    (0, nestjs_rabbitmq_1.RabbitRPC)({
        exchange: contracts_1.SEARCH_EXCHANGE,
        routingKey: contracts_1.SEARCH_PATTERN.INDEX_DOCUMENT_CHUNK_ROUTING_KEY,
        queue: contracts_1.SEARCH_PATTERN.INDEX_DOCUMENT_CHUNK_ROUTING_KEY,
        errorHandler: common_2.customErrorHandler
    }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], SearchController.prototype, "handleIndexDocumentChunk", null);
__decorate([
    (0, nestjs_rabbitmq_1.RabbitSubscribe)({
        exchange: contracts_1.EVENTS_EXCHANGE,
        routingKey: contracts_1.EVENTS.DELETE_DOCUMENT,
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], SearchController.prototype, "handleDeleteDocumentIndex", null);
...
/***/ "./apps/search/src/search/search.module.ts":
/*!*************************************************!*\
  !*** ./apps/search/src/search/search.module.ts ***!
  \*************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const common_1 = __webpack_require__(/*! @nestjs/common */ "@nestjs/common");
const search_service_1 = __webpack_require__(/*! ./search.service */ "./apps/search/src/search/search.service.ts");
const search_controller_1 = __webpack_require__(/*! ./search.controller */ "./apps/search/src/search/search.controller.ts");
const contracts_1 = __webpack_require__(/*! @app/contracts */ "./libs/contracts/src/index.ts");
const nestjs_rabbitmq_1 = __webpack_require__(/*! @golevelup/nestjs-rabbitmq */ "@golevelup/nestjs-rabbitmq");
...
exports.SearchModule = SearchModule = __decorate([
    (0, common_1.Module)({
            ...
            nestjs_rabbitmq_1.RabbitMQModule.forRootAsync({
                ...
                useFactory: (config) => ({
                    exchanges: [
                        ...
                        {
                            name: contracts_1.SEARCH_EXCHANGE,
                            type: 'direct',
                        }
                    ],
        ...
        providers: [search_service_1.SearchService, search_controller_1.SearchController],
    })
], SearchModule);
...
/***/ "./apps/search/src/search/search.service.ts":
/*!**************************************************!*\
  !*** ./apps/search/src/search/search.service.ts ***!
  \**************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const contracts_1 = __webpack_require__(/*! @app/contracts */ "./libs/contracts/src/index.ts");
const common_1 = __webpack_require__(/*! @nestjs/common */ "@nestjs/common");
const meilisearch_1 = __webpack_require__(/*! meilisearch */ "meilisearch");
const BATCH_SIZE = 500;
let SearchService = SearchService_1 = class SearchService {
    meili;
    logger = new common_1.Logger(SearchService_1.name);
    constructor(cfg) {
        this.meili = new meilisearch_1.MeiliSearch({
    ...
    async handleNewMessage(payload) {
        const { _id, discussionId, messageSnapshot, teamSnapshot, participantIds } = payload;
        this.logger.log(`Received new discussion message for ${discussionId}`);
        if (!participantIds?.length)
            return;
        if (messageSnapshot.sender === contracts_1.SENDER_SNAPSHOT_SYSTEM)
            return;
        try {
            const messageDoc = {
            ...
            this.logger.error(`Failed to index new discussion message for ${discussionId}`, error);
        }
    }
    async handleUserUpdated(user) {
        ...
        if (user.name !== undefined)
            partialSender.name = user.name;
        if (user.avatar !== undefined)
            partialSender.avatar = user.avatar;
    ...
    async handleUserAddedToTeam(userId, teamId) {
    ...
    async handleUserRemovedFromTeam(userId, teamId) {
        ...
        try {
            while (true) {
                ...
                const updatedDocsBatch = batch.results.map(doc => ({
                    id: doc.id,
                    participant_ids: (doc.participant_ids || []).filter(id => id !== userId)
                }));
                if (updatedDocsBatch.length > 0) {
                    const task = await index.updateDocuments(updatedDocsBatch);
                    this.logger.log(`Task ${task.taskUid} created for batch of ${updatedDocsBatch.length}`);
    ...
    async handleTeamRemoved(teamId) {
    ...
    async handleDeleteDocumentIndex(fileId) {
        if (!fileId) {
...
exports.SearchService = SearchService = SearchService_1 = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof contracts_1.ClientConfigService !== "undefined" && contracts_1.ClientConfigService) === "function" ? _a : Object])
], SearchService);
...
const search_module_1 = __webpack_require__(/*! ./search/search.module */ "./apps/search/src/search/search.module.ts");
