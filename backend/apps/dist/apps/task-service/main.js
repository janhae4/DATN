...
/***/ "./apps/task-service/src/tasks/tasks.controller.ts":
/*!*********************************************************!*\
  !*** ./apps/task-service/src/tasks/tasks.controller.ts ***!
  \*********************************************************/
...
const tasks_service_1 = __webpack_require__(/*! ./tasks.service */ "./apps/task-service/src/tasks/tasks.service.ts");
...
let TasksController = class TasksController {
    ...
    moveIncompleteTasksToBacklog(payload) {
        return this.tasksService.moveIncompleteTasksToBacklog(payload.sprintId, payload.backlogStatusId);
    }
    unassignTasksFromSprint(payload) {
...
__decorate([
    (0, nestjs_rabbitmq_1.RabbitRPC)({
        ...
        queue: contracts_1.TASK_PATTERNS.CREATE,
        errorHandler: common_2.customErrorHandler,
    }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_b = typeof contracts_1.CreateTaskDto !== "undefined" && contracts_1.CreateTaskDto) === "function" ? _b : Object]),
...
__decorate([
    (0, nestjs_rabbitmq_1.RabbitRPC)({
        ...
        queue: contracts_1.TASK_PATTERNS.FIND_ALL,
        errorHandler: common_2.customErrorHandler,
    }),
    __metadata("design:type", Function),
...
__decorate([
    (0, nestjs_rabbitmq_1.RabbitRPC)({
        ...
        queue: contracts_1.TASK_PATTERNS.FIND_ONE,
        errorHandler: common_2.customErrorHandler,
    }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
...
__decorate([
    (0, nestjs_rabbitmq_1.RabbitRPC)({
        ...
        queue: contracts_1.TASK_PATTERNS.UPDATE,
        errorHandler: common_2.customErrorHandler,
    }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
...
__decorate([
    (0, nestjs_rabbitmq_1.RabbitRPC)({
        ...
        queue: contracts_1.TASK_PATTERNS.REMOVE,
        errorHandler: common_2.customErrorHandler,
    }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
...
__decorate([
    (0, nestjs_rabbitmq_1.RabbitRPC)({
        exchange: 'task_exchange',
        routingKey: contracts_1.TASK_PATTERNS.MOVE_INCOMPLETE_TASKS_TO_BACKLOG,
        queue: contracts_1.TASK_PATTERNS.MOVE_INCOMPLETE_TASKS_TO_BACKLOG,
        errorHandler: common_2.customErrorHandler,
    }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], TasksController.prototype, "moveIncompleteTasksToBacklog", null);
__decorate([
    (0, nestjs_rabbitmq_1.RabbitRPC)({
        exchange: 'task_exchange',
        routingKey: contracts_1.TASK_PATTERNS.UNASSIGN_TASKS_FROM_SPRINT,
        queue: contracts_1.TASK_PATTERNS.UNASSIGN_TASKS_FROM_SPRINT,
        errorHandler: common_2.customErrorHandler,
    }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], TasksController.prototype, "unassignTasksFromSprint", null);
...
/***/ "./apps/task-service/src/tasks/tasks.module.ts":
/*!*****************************************************!*\
  !*** ./apps/task-service/src/tasks/tasks.module.ts ***!
  \*****************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const tasks_service_1 = __webpack_require__(/*! ./tasks.service */ "./apps/task-service/src/tasks/tasks.service.ts");
const tasks_controller_1 = __webpack_require__(/*! ./tasks.controller */ "./apps/task-service/src/tasks/tasks.controller.ts");
const contracts_1 = __webpack_require__(/*! @app/contracts */ "./libs/contracts/src/index.ts");
const nestjs_rabbitmq_1 = __webpack_require__(/*! @golevelup/nestjs-rabbitmq */ "@golevelup/nestjs-rabbitmq");
const task_label_entity_1 = __webpack_require__(Object(function webpackMissingModule() { var e = new Error("Cannot find module '../entities/task-label.entity'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
...
exports.TasksModule = TasksModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forRootAsync({
                ...
                useFactory: (configService) => ({
                    ...
                    entities: [contracts_1.Task, task_label_entity_1.TaskLabel],
                    synchronize: true,
                })
            }),
            typeorm_1.TypeOrmModule.forFeature([contracts_1.Task, task_label_entity_1.TaskLabel]),
            ...
            nestjs_rabbitmq_1.RabbitMQModule.forRootAsync({
                ...
                useFactory: (configService) => ({
                    exchanges: [
                        {
                            name: contracts_1.TASK_EXCHANGE,
                            type: 'topic',
                        },
                        {
        ...
        providers: [tasks_service_1.TasksService, tasks_controller_1.TasksController],
    })
], TasksModule);
...
/***/ "./apps/task-service/src/tasks/tasks.service.ts":
/*!******************************************************!*\
  !*** ./apps/task-service/src/tasks/tasks.service.ts ***!
  \******************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const task_entity_1 = __webpack_require__(/*! @app/contracts/task/entity/task.entity */ "./libs/contracts/src/task/entity/task.entity.ts");
const nestjs_rabbitmq_1 = __webpack_require__(/*! @golevelup/nestjs-rabbitmq */ "@golevelup/nestjs-rabbitmq");
const constants_1 = __webpack_require__(/*! @app/contracts/constants */ "./libs/contracts/src/constants.ts");
const label_event_1 = __webpack_require__(/*! @app/contracts/events/label.event */ "./libs/contracts/src/events/label.event.ts");
const label_entity_1 = __webpack_require__(/*! @app/contracts/label/entity/label.entity */ "./libs/contracts/src/label/entity/label.entity.ts");
const task_label_event_1 = __webpack_require__(/*! @app/contracts/events/task-label.event */ "./libs/contracts/src/events/task-label.event.ts");
const task_label_entity_1 = __webpack_require__(/*! @app/contracts/task/entity/task-label.entity */ "./libs/contracts/src/task/entity/task-label.entity.ts");
let TasksService = class TasksService {
    taskRepository;
    taskLabelRepository;
    amqpConnection;
    constructor(taskRepository, taskLabelRepository, amqpConnection) {
    ...
    async findAllByBackLogs(projectId) {
        return this.taskRepository.find({
            where: { projectId, sprintId: (0, typeorm_2.IsNull)() },
            order: { position: 'ASC' },
        });
    }
    async findOne(id) {
    ...
    async assignLabels(taskId, labelIds) {
        await this.taskLabelRepository.delete({ taskId });
        if (labelIds && labelIds.length > 0) {
            try {
                const labels = await this.amqpConnection.request({
                    exchange: constants_1.LABEL_EXCHANGE,
                    routingKey: task_label_event_1.TaskLabel.GET_DETAILS,
                    payload: { labelIds },
                    timeout: constants_1.RPC_TIMEOUT,
                });
                if (labels && labels.length > 0) {
                    const newLinks = labels.map(label => {
                        const link = new task_label_entity_1.TaskLabel();
                        link.taskId = taskId;
    ...
    async moveIncompleteTasksToBacklog(sprintId, backlogStatusId) {
        return this.taskRepository.update({ sprintId }, { sprintId: null, listId: backlogStatusId });
    }
    async unassignTasksFromSprint(sprintId) {
        return this.taskRepository.update({ sprintId }, { sprintId: null });
    }
    async handleLabelUpdated(label) {
        try {
            await this.taskLabelRepository.update({ labelId: label.id }, { labelName: label.name, labelColor: label.color });
        }
        catch (error) {
            return new nestjs_rabbitmq_1.Nack(true);
        }
    }
    async handleLabelDeleted(payload) {
        try {
...
__decorate([
    (0, nestjs_rabbitmq_1.RabbitSubscribe)({
        exchange: constants_1.EVENTS_EXCHANGE,
        routingKey: label_event_1.LabelEvent.UPDATED,
        queue: 'task-service.label.updated',
    }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_d = typeof label_entity_1.Label !== "undefined" && label_entity_1.Label) === "function" ? _d : Object]),
    __metadata("design:returntype", Promise)
], TasksService.prototype, "handleLabelUpdated", null);
__decorate([
    (0, nestjs_rabbitmq_1.RabbitSubscribe)({
        exchange: constants_1.EVENTS_EXCHANGE,
        routingKey: label_event_1.LabelEvent.DELETED,
        queue: 'task-service.label.deleted',
    }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], TasksService.prototype, "handleLabelDeleted", null);
exports.TasksService = TasksService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(task_entity_1.Task)),
    __param(1, (0, typeorm_1.InjectRepository)(task_label_entity_1.TaskLabel)),
...
/***/ "./libs/contracts/src/events/label.event.ts":
/*!**************************************************!*\
  !*** ./libs/contracts/src/events/label.event.ts ***!
  \**************************************************/
/***/ ((__unused_webpack_module, exports) => {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.LabelEvent = void 0;
var LabelEvent;
(function (LabelEvent) {
    LabelEvent["UPDATED"] = "label.updated";
    LabelEvent["DELETED"] = "label.deleted";
})(LabelEvent || (exports.LabelEvent = LabelEvent = {}));


/***/ }),

/***/ "./libs/contracts/src/events/task-label.event.ts":
/*!*******************************************************!*\
  !*** ./libs/contracts/src/events/task-label.event.ts ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, exports) => {
...
var TaskLabel;
(function (TaskLabel) {
    TaskLabel["GET_DETAILS"] = "task-label.get-details";
})(TaskLabel || (exports.TaskLabel = TaskLabel = {}));
...
const tasks_module_1 = __webpack_require__(/*! ./tasks/tasks.module */ "./apps/task-service/src/tasks/tasks.module.ts");
