...
/***/ "./apps/label-service/src/label-service.module.ts":
/*!********************************************************!*\
  !*** ./apps/label-service/src/label-service.module.ts ***!
  \********************************************************/
...
exports.LabelServiceModule = void 0;
const common_1 = __webpack_require__(/*! @nestjs/common */ "@nestjs/common");
const labels_module_1 = __webpack_require__(/*! ./labels/labels.module */ "./apps/label-service/src/labels/labels.module.ts");
...
let LabelServiceModule = class LabelServiceModule {
};
exports.LabelServiceModule = LabelServiceModule;
exports.LabelServiceModule = LabelServiceModule = __decorate([
    (0, common_1.Module)({
        imports: [
            ...
            typeorm_1.TypeOrmModule.forRootAsync({
                ...
                useFactory: (configService) => ({
                    ...
                    entities: [contracts_1.Label],
                    synchronize: true,
                }),
            }),
            typeorm_1.TypeOrmModule.forFeature([contracts_1.Label]),
...
/***/ "./apps/label-service/src/labels/labels.controller.ts":
/*!************************************************************!*\
  !*** ./apps/label-service/src/labels/labels.controller.ts ***!
  \************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const labels_service_1 = __webpack_require__(/*! ./labels.service */ "./apps/label-service/src/labels/labels.service.ts");
const contracts_1 = __webpack_require__(/*! @app/contracts */ "./libs/contracts/src/index.ts");
...
__decorate([
    (0, microservices_1.MessagePattern)(task_label_event_1.TaskLabel.GET_DETAILS),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], LabelsController.prototype, "getLabelDetails", null);
__decorate([
    (0, microservices_1.MessagePattern)(contracts_1.LABEL_PATTERNS.CREATE),
    __metadata("design:type", Function),
...
__decorate([
    (0, microservices_1.MessagePattern)(contracts_1.LABEL_PATTERNS.FIND_ALL_BY_PROJECT_ID),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], LabelsController.prototype, "findAllByProject", null);
__decorate([
    (0, microservices_1.MessagePattern)(contracts_1.LABEL_PATTERNS.FIND_ONE_BY_ID),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], LabelsController.prototype, "findOne", null);
__decorate([
    (0, microservices_1.MessagePattern)(contracts_1.LABEL_PATTERNS.UPDATE),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], LabelsController.prototype, "update", null);
__decorate([
    (0, microservices_1.MessagePattern)(contracts_1.LABEL_PATTERNS.REMOVE),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
...
exports.LabelsController = LabelsController = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof labels_service_1.LabelsService !== "undefined" && labels_service_1.LabelsService) === "function" ? _a : Object])
], LabelsController);


/***/ }),

/***/ "./apps/label-service/src/labels/labels.module.ts":
/*!********************************************************!*\
  !*** ./apps/label-service/src/labels/labels.module.ts ***!
  \********************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const common_1 = __webpack_require__(/*! @nestjs/common */ "@nestjs/common");
const labels_controller_1 = __webpack_require__(/*! ./labels.controller */ "./apps/label-service/src/labels/labels.controller.ts");
const labels_service_1 = __webpack_require__(/*! ./labels.service */ "./apps/label-service/src/labels/labels.service.ts");
const typeorm_1 = __webpack_require__(/*! @nestjs/typeorm */ "@nestjs/typeorm");
...
exports.LabelsModule = LabelsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([label_entity_1.Label]), nestjs_rabbitmq_1.RabbitMQModule],
...
/***/ "./apps/label-service/src/labels/labels.service.ts":
/*!*********************************************************!*\
  !*** ./apps/label-service/src/labels/labels.service.ts ***!
  \*********************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
let LabelsService = class LabelsService {
    labelRepository;
    amqpConnection;
    constructor(labelRepository, amqpConnection) {
        this.labelRepository = labelRepository;
        this.amqpConnection = amqpConnection;
    }
    create(createLabelDto) {
        if (!createLabelDto) {
            throw new common_1.BadRequestException('CreateLabelDto is required');
        }
        if (!createLabelDto.name) {
            throw new common_1.BadRequestException('Label name is required');
        }
    ...
    async update(id, updateLabelDto) {
        ...
        if (!label) {
            throw new common_1.BadRequestException('Label not found');
        }
        Object.assign(label, updateLabelDto);
        const updatedLabel = await this.labelRepository.save(label);
        this.amqpConnection.publish(constants_1.EVENTS_EXCHANGE, label_event_1.LabelEvent.UPDATED, updatedLabel);
        return updatedLabel;
    }
    async remove(id) {
        const result = await this.labelRepository.delete(id);
        if (result.affected && result.affected > 0) {
            this.amqpConnection.publish(constants_1.EVENTS_EXCHANGE, label_event_1.LabelEvent.DELETED, { id });
        }
        return result;
    }
};
...
exports.LabelsService = LabelsService = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof typeorm_2.Repository !== "undefined" && typeorm_2.Repository) === "function" ? _a : Object, typeof (_b = typeof nestjs_rabbitmq_1.AmqpConnection !== "undefined" && nestjs_rabbitmq_1.AmqpConnection) === "function" ? _b : Object])
], LabelsService);
...
/*!****************************************!*\
  !*** ./apps/label-service/src/main.ts ***!
  \****************************************/

Object.defineProperty(exports, "__esModule", ({ value: true }));
const core_1 = __webpack_require__(/*! @nestjs/core */ "@nestjs/core");
const label_service_module_1 = __webpack_require__(/*! ./label-service.module */ "./apps/label-service/src/label-service.module.ts");
const common_1 = __webpack_require__(/*! @nestjs/common */ "@nestjs/common");
const contracts_1 = __webpack_require__(/*! @app/contracts */ "./libs/contracts/src/index.ts");
async function bootstrap() {
    const appContext = await core_1.NestFactory.create(label_service_module_1.LabelServiceModule);
    const configService = appContext.get(contracts_1.ClientConfigService);
    appContext.connectMicroservice(configService.labelClientOptions);
    await appContext.startAllMicroservices();
    await appContext.init();
    common_1.Logger.log('Label Service is listening RabbitMQ messages...', 'Bootstrap');
}
bootstrap();
