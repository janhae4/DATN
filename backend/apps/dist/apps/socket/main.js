...
/***/ "./apps/socket/src/redis-io.adapter.ts":
/*!*********************************************!*\
  !*** ./apps/socket/src/redis-io.adapter.ts ***!
  \*********************************************/
...
/***/ "./apps/socket/src/socket.controller.ts":
/*!**********************************************!*\
  !*** ./apps/socket/src/socket.controller.ts ***!
  \**********************************************/
...
const socket_gateway_1 = __webpack_require__(/*! ./socket.gateway */ "./apps/socket/src/socket.gateway.ts");
...
let SocketController = class SocketController {
    ...
    handleLogin(payload) {
        this.socketGateway.sendNotificationToUser({
            ...
            type: contracts_1.NotificationType.SUCCESS,
        });
    }
    ...
    handleCreateTeam(payload) {
        ...
        membersToNotify.map((m) => this.socketGateway.sendNotificationToUser({
            userId: m,
    ...
    handleMemberRoleChanged(payload) {
    ...
    handleGetProcessDocument(event) {
        this.socketGateway.sendNotificationToUser(event);
    }
    handleStreamResponse(response) {
        this.socketGateway.handleStreamResponse(response);
    }
    handleFileStatus(payload) {
        console.log(payload);
        this.socketGateway.handleFileStatus(payload.fileId, payload.fileName, payload.status, payload.userId, payload.teamId);
    }
    handleCompleteUpload(payload) {
...
__decorate([
    (0, nestjs_rabbitmq_1.RabbitSubscribe)({
        ...
        queue: contracts_1.EVENTS.LOGIN,
...
], SocketController.prototype, "handleLogin", null);
__decorate([
    (0, nestjs_rabbitmq_1.RabbitSubscribe)({
        exchange: contracts_1.EVENTS_EXCHANGE,
        routingKey: contracts_1.EVENTS.NEW_MESSAGE,
        queue: contracts_1.EVENTS.NEW_MESSAGE,
        errorHandler: common_2.customErrorHandler
    }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], SocketController.prototype, "handleNewMessage", null);
__decorate([
    (0, nestjs_rabbitmq_1.RabbitSubscribe)({
        exchange: contracts_1.EVENTS_EXCHANGE,
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], SocketController.prototype, "handleCreateTeam", null);
__decorate([
    (0, nestjs_rabbitmq_1.RabbitSubscribe)({
        exchange: contracts_1.EVENTS_EXCHANGE,
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], SocketController.prototype, "handleAddMember", null);
__decorate([
    (0, nestjs_rabbitmq_1.RabbitSubscribe)({
        exchange: contracts_1.EVENTS_EXCHANGE,
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], SocketController.prototype, "handleMemberRoleChanged", null);
__decorate([
    (0, nestjs_rabbitmq_1.RabbitSubscribe)({
        exchange: contracts_1.EVENTS_EXCHANGE,
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], SocketController.prototype, "handleRemoveMember", null);
__decorate([
    (0, nestjs_rabbitmq_1.RabbitSubscribe)({
        exchange: contracts_1.EVENTS_EXCHANGE,
        routingKey: contracts_1.EVENTS.REMOVE_MEMBER,
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], SocketController.prototype, "handleTeamDeleted", null);
__decorate([
    (0, nestjs_rabbitmq_1.RabbitSubscribe)({
        exchange: contracts_1.EVENTS_EXCHANGE,
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], SocketController.prototype, "handleLeaveTeam", null);
__decorate([
    (0, nestjs_rabbitmq_1.RabbitSubscribe)({
        exchange: contracts_1.EVENTS_EXCHANGE,
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], SocketController.prototype, "handleRemoveTeam", null);
__decorate([
    (0, nestjs_rabbitmq_1.RabbitSubscribe)({
        exchange: contracts_1.SOCKET_EXCHANGE,
        routingKey: contracts_1.NOTIFICATION_PATTERN.SEND,
        queue: "events_socket_send_notification",
        errorHandler: common_2.customErrorHandler
    }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_c = typeof contracts_1.NotificationEventDto !== "undefined" && contracts_1.NotificationEventDto) === "function" ? _c : Object]),
    __metadata("design:returntype", void 0)
], SocketController.prototype, "handleSendNotification", null);
__decorate([
    (0, nestjs_rabbitmq_1.RabbitSubscribe)({
        exchange: contracts_1.SOCKET_EXCHANGE,
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], SocketController.prototype, "handleTeamSendNotification", null);
__decorate([
    (0, nestjs_rabbitmq_1.RabbitSubscribe)({
        exchange: contracts_1.CHATBOT_EXCHANGE,
        routingKey: contracts_1.NOTIFICATION_PATTERN.PROCESS_DOCUMENT,
        queue: contracts_1.NOTIFICATION_PATTERN.PROCESS_DOCUMENT,
        errorHandler: common_2.customErrorHandler
    }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_d = typeof contracts_1.NotificationEventDto !== "undefined" && contracts_1.NotificationEventDto) === "function" ? _d : Object]),
    __metadata("design:returntype", void 0)
], SocketController.prototype, "handleGetProcessDocument", null);
__decorate([
    (0, nestjs_rabbitmq_1.RabbitSubscribe)({
        exchange: contracts_1.EVENTS_EXCHANGE,
        routingKey: contracts_1.CHATBOT_PATTERN.STREAM_RESPONSE,
        queue: contracts_1.CHATBOT_PATTERN.STREAM_RESPONSE,
        errorHandler: common_2.customErrorHandler
    }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_e = typeof contracts_1.ResponseStreamDto !== "undefined" && contracts_1.ResponseStreamDto) === "function" ? _e : Object]),
    __metadata("design:returntype", void 0)
], SocketController.prototype, "handleStreamResponse", null);
__decorate([
    (0, nestjs_rabbitmq_1.RabbitSubscribe)({
        exchange: contracts_1.EVENTS_EXCHANGE,
        routingKey: contracts_1.FILE_PATTERN.FILE_STATUS,
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], SocketController.prototype, "handleFileStatus", null);
__decorate([
    (0, nestjs_rabbitmq_1.RabbitSubscribe)({
        exchange: contracts_1.SOCKET_EXCHANGE,
        routingKey: contracts_1.FILE_PATTERN.COMPLETE_UPLOAD,
        queue: contracts_1.FILE_PATTERN.COMPLETE_UPLOAD,
        errorHandler: common_2.customErrorHandler
    }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], SocketController.prototype, "handleCompleteUpload", null);
exports.SocketController = SocketController = __decorate([
    (0, common_1.Controller)(),
    __metadata("design:paramtypes", [typeof (_a = typeof socket_gateway_1.SocketGateway !== "undefined" && socket_gateway_1.SocketGateway) === "function" ? _a : Object])
], SocketController);


/***/ }),

/***/ "./apps/socket/src/socket.gateway.ts":
/*!*******************************************!*\
  !*** ./apps/socket/src/socket.gateway.ts ***!
  \*******************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
let SocketGateway = SocketGateway_1 = class SocketGateway {
    ...
    async handleInteraction(client, payload) {
        const { userId, discussionId } = payload;
        const savedConversation = await this.amqpConnection.request({
            exchange: contracts_1.CHATBOT_EXCHANGE,
        ...
        if (!savedConversation) {
            this.logger.error(`Client ${userId} - Saved conversation is null or undefined after handleUserMessage for user ${userId}`);
            const payload = {
                type: contracts_1.NotificationType.FAILED,
        ...
        this.logger.log(`Client ${client.id} - Saved conversation: ${String(savedConversation._id)}`);
        if (!discussionId) {
            this.logger.log(`Emitting new conversation ID: ${String(savedConversation._id)} for client ${client.id}`);
    ...
    async handleAskQuestion(client, payload) {
        const user = client.data.user;
        if (!user) {
        ...
        try {
            const savedDiscussion = await this.amqpConnection.request({
                exchange: contracts_1.CHATBOT_EXCHANGE,
                routingKey: contracts_1.CHATBOT_PATTERN.HANDLE_MESSAGE,
                payload: {
                    userId: user.id,
    ...
    async handleSummarizeDocument(client, payload) {
        const user = client.data.user;
        if (!user)
            return;
    ...
    handleStreamResponse(response) {
        ...
        if (!membersToNotify || membersToNotify.length === 0) {
            ...
            client.emit(contracts_1.CHATBOT_PATTERN.RESPONSE_ERROR, { content: "Lỗi: Không tìm thấy người nhận stream (stream session error)." });
            return;
        }
        ...
        if (type === 'chunk') {
            ...
            emitToAll(contracts_1.CHATBOT_PATTERN.RESPONSE_CHUNK, content);
        }
        else if (type === 'start') {
            emitToAll(contracts_1.CHATBOT_PATTERN.RESPONSE_START, content);
        }
        else if (type === 'error') {
            emitToAll(contracts_1.CHATBOT_PATTERN.RESPONSE_ERROR, { content });
        }
            ...
            emitToAll(contracts_1.CHATBOT_PATTERN.RESPONSE_END, content);
            const fullMessage = client.data.accumulatedMessage || '';
            if (fullMessage.trim().length > 0) {
                this.amqpConnection.publish(contracts_1.CHATBOT_EXCHANGE, contracts_1.CHATBOT_PATTERN.CREATE, {
                    discussionId,
                    message: fullMessage,
                    metadata: client.data.streamMetadata,
                });
                this.logger.log(`Saved streamed AI message for ${socketId} to discussion ${discussionId}.`);
            }
    ...
    sendNotificationToUser(event) {
        ...
        this.amqpConnection.publish(contracts_1.NOTIFICATION_EXCHANGE, contracts_1.NOTIFICATION_PATTERN.CREATE, event);
    }
    handleNewMessage(payload) {
        const { discussionId, _id, messageSnapshot, membersToNotify } = payload;
    ...
    handleFileStatus(fileId, fileName, fileStatus, userId, teamId) {
        this.server.to(teamId || userId).emit('file_status', { id: fileId, status: fileStatus, name: fileName });
    }
    handleUploadCompletion(fileId, status, userId, teamId) {
...
], SocketGateway.prototype, "joinRoom", null);
__decorate([
    (0, websockets_1.SubscribeMessage)(contracts_1.CHATBOT_PATTERN.ASK_QUESTION),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, typeof (_c = typeof contracts_1.AskQuestionDto !== "undefined" && contracts_1.AskQuestionDto) === "function" ? _c : Object]),
    __metadata("design:returntype", Promise)
], SocketGateway.prototype, "handleAskQuestion", null);
__decorate([
    (0, websockets_1.SubscribeMessage)(contracts_1.CHATBOT_PATTERN.SUMMARIZE_DOCUMENT),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, typeof (_d = typeof contracts_1.SummarizeDocumentDto !== "undefined" && contracts_1.SummarizeDocumentDto) === "function" ? _d : Object]),
    __metadata("design:returntype", Promise)
], SocketGateway.prototype, "handleSummarizeDocument", null);
...
/***/ "./apps/socket/src/socket.module.ts":
/*!******************************************!*\
  !*** ./apps/socket/src/socket.module.ts ***!
  \******************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const common_1 = __webpack_require__(/*! @nestjs/common */ "@nestjs/common");
const socket_controller_1 = __webpack_require__(/*! ./socket.controller */ "./apps/socket/src/socket.controller.ts");
const socket_gateway_1 = __webpack_require__(/*! ./socket.gateway */ "./apps/socket/src/socket.gateway.ts");
const contracts_1 = __webpack_require__(/*! @app/contracts */ "./libs/contracts/src/index.ts");
const nestjs_rabbitmq_1 = __webpack_require__(/*! @golevelup/nestjs-rabbitmq */ "@golevelup/nestjs-rabbitmq");
...
exports.SocketModule = SocketModule = __decorate([
    (0, common_1.Module)({
        imports: [
            ...
            nestjs_rabbitmq_1.RabbitMQModule.forRootAsync({
                ...
                useFactory: (config) => ({
                    exchanges: [
                        {
                            name: contracts_1.SOCKET_EXCHANGE,
                            type: 'direct',
                        },
                        {
        ...
        providers: [socket_gateway_1.SocketGateway, socket_controller_1.SocketController],
    })
], SocketModule);
...
const contracts_1 = __webpack_require__(/*! @app/contracts */ "./libs/contracts/src/index.ts");
const socket_module_1 = __webpack_require__(/*! ./socket.module */ "./apps/socket/src/socket.module.ts");
const redis_io_adapter_1 = __webpack_require__(/*! ./redis-io.adapter */ "./apps/socket/src/redis-io.adapter.ts");
async function bootstrap() {
    const app = await core_1.NestFactory.create(socket_module_1.SocketModule);
    const cfg = app.get(contracts_1.ClientConfigService);
