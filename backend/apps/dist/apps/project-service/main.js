...
/***/ "./apps/project-service/src/project-service.module.ts":
/*!************************************************************!*\
  !*** ./apps/project-service/src/project-service.module.ts ***!
  \************************************************************/
...
exports.ProjectServiceModule = void 0;
const common_1 = __webpack_require__(/*! @nestjs/common */ "@nestjs/common");
const contracts_1 = __webpack_require__(/*! @app/contracts */ "./libs/contracts/src/index.ts");
const projects_module_1 = __webpack_require__(/*! ./projects/projects.module */ "./apps/project-service/src/projects/projects.module.ts");
let ProjectServiceModule = class ProjectServiceModule {
};
exports.ProjectServiceModule = ProjectServiceModule;
exports.ProjectServiceModule = ProjectServiceModule = __decorate([
    (0, common_1.Module)({
        imports: [
...
/***/ "./apps/project-service/src/projects/projects.controller.ts":
/*!******************************************************************!*\
  !*** ./apps/project-service/src/projects/projects.controller.ts ***!
  \******************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const common_1 = __webpack_require__(/*! @nestjs/common */ "@nestjs/common");
const contracts_1 = __webpack_require__(/*! @app/contracts */ "./libs/contracts/src/index.ts");
const projects_service_1 = __webpack_require__(/*! ./projects.service */ "./apps/project-service/src/projects/projects.service.ts");
...
let ProjectsController = class ProjectsController {
    ...
    async findAllByTeamId(payload) {
        return await this.projectService.findAllByTeamId(payload.teamId);
    }
};
exports.ProjectsController = ProjectsController;
__decorate([
    (0, microservices_1.MessagePattern)(contracts_1.PROJECT_PATTERNS.CREATE),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_b = typeof contracts_1.CreateProjectDto !== "undefined" && contracts_1.CreateProjectDto) === "function" ? _b : Object]),
    __metadata("design:returntype", Promise)
], ProjectsController.prototype, "create", null);
__decorate([
    (0, microservices_1.MessagePattern)(contracts_1.PROJECT_PATTERNS.GET_BY_ID),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], ProjectsController.prototype, "findOne", null);
__decorate([
    (0, microservices_1.MessagePattern)(contracts_1.PROJECT_PATTERNS.UPDATE),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], ProjectsController.prototype, "update", null);
__decorate([
    (0, microservices_1.MessagePattern)(contracts_1.PROJECT_PATTERNS.REMOVE),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], ProjectsController.prototype, "remove", null);
__decorate([
    (0, microservices_1.MessagePattern)(contracts_1.PROJECT_PATTERNS.FIND_ALL_BY_TEAM_ID),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], ProjectsController.prototype, "findAllByTeamId", null);
...
/***/ "./apps/project-service/src/projects/projects.module.ts":
/*!**************************************************************!*\
  !*** ./apps/project-service/src/projects/projects.module.ts ***!
  \**************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const projects_service_1 = __webpack_require__(/*! ./projects.service */ "./apps/project-service/src/projects/projects.service.ts");
const projects_controller_1 = __webpack_require__(/*! ./projects.controller */ "./apps/project-service/src/projects/projects.controller.ts");
const project_entity_1 = __webpack_require__(/*! @app/contracts/project/entity/project.entity */ "./libs/contracts/src/project/entity/project.entity.ts");
const contracts_1 = __webpack_require__(/*! @app/contracts */ "./libs/contracts/src/index.ts");
const microservices_1 = __webpack_require__(/*! @nestjs/microservices */ "@nestjs/microservices");
...
/***/ "./apps/project-service/src/projects/projects.service.ts":
/*!***************************************************************!*\
  !*** ./apps/project-service/src/projects/projects.service.ts ***!
  \***************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
let ProjectsService = class ProjectsService {
    projectRepository;
    listClient;
    constructor(projectRepository, listClient) {
    ...
    async create(createProjectDto) {
        ...
        this.listClient.emit(project_events_1.PROJECT_EVENTS.PROJECT_CREATED, {
...
exports.ProjectsService = ProjectsService = __decorate([
    ...
    __param(1, (0, common_1.Inject)(contracts_1.LIST_EXCHANGE)),
    __metadata("design:paramtypes", [typeof (_a = typeof typeorm_2.Repository !== "undefined" && typeorm_2.Repository) === "function" ? _a : Object, typeof (_b = typeof client_proxy_1.ClientProxy !== "undefined" && client_proxy_1.ClientProxy) === "function" ? _b : Object])
], ProjectsService);
...
const common_1 = __webpack_require__(/*! @nestjs/common */ "@nestjs/common");
const contracts_1 = __webpack_require__(/*! @app/contracts */ "./libs/contracts/src/index.ts");
const project_service_module_1 = __webpack_require__(/*! ./project-service.module */ "./apps/project-service/src/project-service.module.ts");
async function bootstrap() {
    const appContext = await core_1.NestFactory.create(project_service_module_1.ProjectServiceModule);
    const configService = appContext.get(contracts_1.ClientConfigService);
    appContext.connectMicroservice(configService.projectClientOptions);
    await appContext.startAllMicroservices();
    await appContext.init();
    common_1.Logger.log('Project Service is listening RabbitMQ messages...', 'Bootstrap');
}
bootstrap();
