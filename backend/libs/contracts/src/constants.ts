...
export const N8N_CLIENT = Symbol('N8N_CLIENT');
...
export const GMAIL_EXCHANGE = 'gmail_topic_exchange';
export const GMAIL_QUEUE = 'gmail_topic_queue';
...
export const N8N_EXCHANGE = 'n8n_exchange';
export const N8N_QUEUE = 'n8n_queue';
...
export const N8N_SERVICE = 'n8n-service';