...
REMOVE_COLLECTION_ROUTING_KEY = os.getenv("REMOVE_COLLECTION_ROUTING_KEY", "events.delete.document")
...
SUMMARIZE_MEETING_ROUTING_KEY = os.getenv("SUMMARIZE_MEETING_ROUTING_KEY", "summarize_meeting")
RESPONSE_SUMMARIZE_MEETING_ROUTING_KEY = os.getenv("RESPONSE_SUMMARIZE_MEETING_ROUTING_KEY", "summarize_meeting.response")